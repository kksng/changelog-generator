...
const link = 'https://jira.com/browse/';
const message = '[TASK-1876](https://jira.com/browse/TASK-1876): Исправлена валидация поля email при восстановлении пароля';
...
describe('lib/parser: addLinkToRow', () => {
  test('Should return message with link', () => {
    ...
    expect(messageWithLink).toEqual('[TASK-1876](https://jira.com/browse/TASK-1876): Исправлена валидация поля email при восстановлении пароля');
  });
